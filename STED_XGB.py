...
def xgb_eval(eta, min_child_weight, max_depth, gamma, subsample, colsample_bytree):
    params = {'eta':eta, 'min_child_weight':min_child_weight, 'max_depth':max_depth, 'gamma':gamma, 'subsample':subsample, 'colsample_bytree':colsample_bytree}
